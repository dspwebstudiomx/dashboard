...
const DashboardPage = () => {
  return (
    <DashboardTemplate>
      ...
      <div className="grid grid-cols-1  sm:grid-cols-5 gap-12 p-6">
        {/* Resumen de Proyectos */}
        <div className="bg-white p-6 rounded-lg shadow-md sm:col-span-5 lg:col-span-2 2xl:col-span-2">
          <h2 className="text-xl font-semibold mb-4">Resumen de Proyectos</h2>
          <ProjectSummary />
        </div>

        {/* Gráfico de Ingresos */}
        <div className="bg-white p-6 rounded-lg shadow-md sm:col-span-5 lg:col-span-3 2xl:col-span-3">
        ...
        {/* Lista de Tareas */}
        <div className="bg-white p-6 rounded-lg shadow-md sm:col-span-5 lg:col-span-2 xl:col-span-2 2xl:col-span-2">
