...
const DashboardTemplate = ({ children, title }) => {
	return (
		<div className="w-full flex flex-col bg-blue-900 dark:bg-gray-900">
			...
			{/* Contenido principal */}
			<main
				className={`grid grid-cols-12 gap-40 p-0 pt-32 md:mt-8 lg:mt-6 xl:mt-20 2xl:px-0 2xl:py-10 min-h-[84.8vh] dark:bg-gray-900 text-gray-800 dark:text-gray-100 mx-auto`}
			>
				{/* Sidebar siempre visible en el lado derecho */}
				<div className="col-span-12 md:col-span-1 h-full px-4 md:px-0 fixed">
					<Sidebar isOpen={true} />
				</div>
				{/* Contenido principal */}
