...
const Modal = ({ isOpen, children, title }) => {
  ...
  return (
    <section className="fixed inset-0 bg-black/30 dark:bg-black/80 flex items-center justify-center z-50">
      <article className=" bg-white rounded-lg shadow-lg w-[90vw] h-auto xl:h-auto 2xl:w-auto 2xl:h-auto md:max-w-full p-6 md:p-12 xl:p-16 border-4 border-blue-400 dark:bg-gray-800 dark:border-gray-700 flex flex-col gap-6 justify-between">
        {/* Título del modal */}
        {title && (
